...
/*   Updated: 2024/01/23 13:05:57 by eallas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * Function to iterate over the fourth digit and call ft_write_chars.
 *
 ...
 */
void	iterate_fourth_digit(char first_digit, char second_digit,
		char third_digit)
{
	char	fourth_digit;
	...
	{
		ft_write_chars(first_digit, second_digit, third_digit, fourth_digit);
		++fourth_digit;
	}
}

/**
 *  Function to iterate over the third digit and call iterate_fourth_digit.
 *
 ...
 *
 */
void	iterate_third_digit(char first_digit, char second_digit)
{
	char	third_digit;
	...
	while (third_digit <= '9')
	{
		iterate_fourth_digit(first_digit, second_digit, third_digit);
		++third_digit;
	}
}

/**
 * Function to iterate over the second digit and call iterate_third_digit.
 *
 ...
 *
 */
void	iterate_second_digit(char first_digit)
{
	char	second_digit;
	...
	{
		iterate_third_digit(first_digit, second_digit);
		++second_digit;
	}
}
...
void	ft_print_comb2(void)
{
	...
	while (first_digit <= '9')
	{
		iterate_second_digit(first_digit);
		++first_digit;
	}
}
